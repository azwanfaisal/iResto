                ...
                <div class="py-6 px-8">
                    ...
                    <div class="flex flex-wrap items-center justify-between mb-6">
                        <form action="{{ route('karyawan.index') }}" method="GET" class="flex space-x-2">
                            ...
                            <select name="jabatan" class="px-4 py-2 border border-gray-300 rounded-lg dark:bg-gray-800 dark:border-gray-600 dark:text-gray-300">
                                <option value="">All</option>
                                <option value="kasir" {{ request('jabatan') == 'kasir' ? 'selected' : '' }}>Kasir</option>
                                <option value="pelayan" {{ request('jabatan') == 'pelayan' ? 'selected' : '' }}>Pelayan</option>
                                <option value="chef" {{ request('jabatan') == 'chef' ? 'selected' : '' }}>Chef</option>
                                ...
                                @forelse($karyawans as $key => $item)
                                    <tr class="border-b bg-gray-100 hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700 transition duration-200">
                                        ...
                                        <td class="px-6 py-4 flex items-center space-x-3">
                                            ...
                                            <span class="font-medium text-gray-900 dark:text-gray-200">{{ $item->nama_lengkap }}</span>
                                        </td>
