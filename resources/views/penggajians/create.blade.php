                    ...
                    <form method="POST" action="{{ route('penggajians.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="tunjangan_transport" class="block mt-1 w-full" type="number" 
                                name="tunjangan_transport" value="{{ old('tunjangan_transport', 0) }}" required />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="tunjangan_makan" class="block mt-1 w-full" type="number" 
                                name="tunjangan_makan" value="{{ old('tunjangan_makan', 0) }}" required />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="tunjangan_lembur" class="block mt-1 w-full" type="number" 
                                name="tunjangan_lembur" value="{{ old('tunjangan_lembur', 0) }}" required />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="tanggal_gajian" class="block mt-1 w-full" type="date" 
                                name="tanggal_gajian" value="{{ old('tanggal_gajian') }}" required />
